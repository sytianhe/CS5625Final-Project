...
public class Leafmesh2 extends Trimesh {
	
	public Leafmesh2(ArrayList<Point3f>list2, float width) {
		Point3f vt1 = new Point3f(list2.get(0));
		Point3f vt2 = new Point3f(list2.get(1));
		Point3f vt3 = new Point3f(list2.get(2));
		
		
		// Find the two side control points of the leave
		Point3f vt4 = new Point3f();

		vt4.sub(vt2, vt1);
		vt4.scale(0.25f);
		vt4.add(vt1);
		
		Vector3f stemV = new Vector3f();
		stemV.sub(vt2, vt1);
		Vector3f stemV2 = new Vector3f();
		stemV2.sub(vt3, vt4);
		stemV.cross(stemV, stemV2);
		stemV.normalize();
		
		Point3f vt5 = new Point3f(vt4);

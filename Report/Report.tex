...
\begin{enumerate}
\item{Design a skeleton mesh procedurally for the palm tree rendering and physical simulation. - Tianhe }
...
\begin{enumerate}
\item{Learn the hair model described in [1] - Michael}
\item{Optimize leaves and fonds simulation by using the interpolation of leaves and fronds based on the hair model. - Tianhe}
...
\item{Implement wind simulation - Michael}
\item{Test and report - Tianhe}
\end{enumerate}
